...
{% if stripe_enabled %}
<p>{{ '6 € / месец + приложимото ДДС. Крайната сума се показва в Stripe преди потвърждение.' if stripe_live else 'ТЕСТОВ РЕЖИМ — използвайте само тестова карта. Няма истинско плащане.' }}</p>
